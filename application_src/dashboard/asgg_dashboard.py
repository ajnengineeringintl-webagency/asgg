...
def asgg_dashboard():
    ...
    recordings = asgg_app_database_models_dashboard_data__dataRecordings.query.all()
...
def asgg_recordings_edit(rcid):
        ...
        recordings = asgg_app_database_models_dashboard_data__dataRecordings.query.get(recordingid)
        #db.session.commit()
        if not recordings:
