...
def asgg_app_server(): 
    ...
    application.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://neondb_owner:npg_fe8IS7KuizJg@ep-lucky-cloud-aw7wyvjv-pooler.c-12.us-east-1.aws.neon.tech/neondb?channel_binding=require&sslmode=require"
